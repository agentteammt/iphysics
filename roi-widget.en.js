/* ============================================================
   Potential Calculator Widget (14.07.) — eingebettetes Overlay-Fenster.
   ...
   Trigger: Button mit id="roi-open" (im ROI teaser).
   Barrierefrei: ESC schließt schrittweise, sichtbare Fokus-Ringe.
   ============================================================ */
(function () {
  "use strict";
  var CALC_URL = "./roi-check.en.html";
  ...
  function build(anchor) {
    ...
    shell.setAttribute("aria-label", "Potential Calculator");
    ...
    var titleWrap = el("div", "display:flex;flex-direction:column;gap:3px;min-width:0;",
      ...
      '<div style="font-weight:700;font-size:15px;line-height:1;color:#10262E;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">Potential Calculator</div>');
    var btnBox = el("div", "display:flex;align-items:center;gap:8px;flex-shrink:0;");

    var maxBtn = el("button", ICON_BTN, ICON_MAX);
    maxBtn.type = "button"; maxBtn.title = "Enlarge window"; maxBtn.setAttribute("aria-label", "Enlarge window");
    var restoreBtn = el("button", ICON_BTN.replace("display:grid", "display:none"), ICON_RESTORE);
    restoreBtn.type = "button"; restoreBtn.title = "Back to preview"; restoreBtn.setAttribute("aria-label", "Back to preview");
    var minBtn = el("button", ICON_BTN, ICON_MIN);
    minBtn.type = "button"; minBtn.title = "Minimise window"; minBtn.setAttribute("aria-label", "Minimise window");
    ...
    var loader = el("div", "position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:20px;padding:24px;text-align:center;",
      '<div style="font-weight:600;font-size:11px;letter-spacing:.3em;text-transform:uppercase;color:#6B7E86;">Loading the Potential Calculator</div>' +
    ...
    frame.title = "Potential Calculator";
    ...
    bubble.type = "button"; bubble.title = "Open the Potential Calculator"; bubble.setAttribute("aria-label", "Open the Potential Calculator");
