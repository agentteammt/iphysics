/* ============================================================
   Calcolatore del risparmio potenziale Widget (14.07.) — eingebettetes Overlay-Fenster.
   ...
   Trigger: Button mit id="roi-open" (im Richiamo ROI).
...
(function () {
  ...
  function build(anchor) {
    ...
    shell.setAttribute("aria-label", "Calcolatore del risparmio potenziale");
    ...
    var titleWrap = el("div", "display:flex;flex-direction:column;gap:3px;min-width:0;",
      ...
      '<div style="font-weight:700;font-size:15px;line-height:1;color:#10262E;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">Calcolatore del risparmio potenziale</div>');
    var btnBox = el("div", "display:flex;align-items:center;gap:8px;flex-shrink:0;");

    var maxBtn = el("button", ICON_BTN, ICON_MAX);
    maxBtn.type = "button"; maxBtn.title = "Ingrandisci la finestra"; maxBtn.setAttribute("aria-label", "Ingrandisci la finestra");
    var restoreBtn = el("button", ICON_BTN.replace("display:grid", "display:none"), ICON_RESTORE);
    restoreBtn.type = "button"; restoreBtn.title = "Torna all’anteprima"; restoreBtn.setAttribute("aria-label", "Torna all’anteprima");
    var minBtn = el("button", ICON_BTN, ICON_MIN);
    minBtn.type = "button"; minBtn.title = "Riduci la finestra"; minBtn.setAttribute("aria-label", "Riduci la finestra");
    ...
    var loader = el("div", "position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:20px;padding:24px;text-align:center;",
      '<div style="font-weight:600;font-size:11px;letter-spacing:.3em;text-transform:uppercase;color:#6B7E86;">Caricamento del Calcolatore del risparmio potenziale</div>' +
    ...
    frame.title = "Calcolatore del risparmio potenziale";
    ...
    bubble.type = "button"; bubble.title = "Apri il Calcolatore del risparmio potenziale"; bubble.setAttribute("aria-label", "Apri il Calcolatore del risparmio potenziale");
    ...
    function apply() {
      ...
      // Maximiert: Seite dahinter nicht scrollbar (v. a. mobil wichtig)
      document.documentElement.style.overflow = mode === "maximized" ? "hidden" : "";
