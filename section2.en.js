...
export function initSection2() {
  ...
  /* ---------- Count-ups ---------- */
  const fmt = (n, sep) => sep ? Math.round(n).toLocaleString("en-GB") : String(Math.round(n));
  ...
  function layout() {
    ...
    /* Demo booking (Änd. 3, 06.07.): Desktop zweispaltig, mobil untereinander — Höhe des
    ...
    /* ROI teaser (21.07.): mobil einspaltig — Button rutscht unter den Text */
...
function hint(box) {
  ...
  t.textContent = "Video source to follow — asset B";
